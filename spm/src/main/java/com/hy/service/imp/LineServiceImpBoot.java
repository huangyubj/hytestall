...
//简单操作
@Service("lineServiceBoot")
public class LineServiceImpBoot implements LineService {
    protected static final String CACHENAME  = "csc_line_";
    @Autowired
    private CscLineMapper cscLineMapper;

    @Cacheable(value = "cscLine_")
    @Override
    ...
    @CachePut(value = "cscLine_", key = "#entity.lineId")
    @Override
    ...
    @CacheEvict(value = "cscLine_", key = "#entity.lineId")
    @Override
